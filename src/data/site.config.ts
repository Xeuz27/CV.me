...
export const siteConfig: SiteConfig = {
  ...
  vision:
    "Convertirme en un referente reconocido por mi capacidad para guiar a emprendedores y empresarios hacia el éxito digital, inspirando cambios significativos y contribuyendo al crecimiento sostenible de la industria tecnológica a nivel global",
};
