---
id: "formulario-typescript-error-types"
...
<img class="mx-auto aspect-auto max-h-[580px] md:max-h-64 lg:max-h-96 xl:max-h-[360px]" src='/stringnotDate.png' alt="nvstore en vista movil" />
</div>
